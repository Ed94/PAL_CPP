...
#include "LAL.ASCII.hpp"

/*
C-String library intended to be used as a interface to traditional character arrays used in most third-party libraries.

This should really only be used when interfacing with foreign code.
*/
